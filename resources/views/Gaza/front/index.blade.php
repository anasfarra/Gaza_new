          ...
          <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div class="flex justify-between items-center mb-12">
                <h2 class="text-3xl font-bold">مشاريع مميزة</h2><a href="{{ route('Gaza.projects') }}" data-discover="true"><button
                    data-slot="button"
          ...
          <section class="py-16 bg-white text-neutral-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div class="text-center">
                <a href="{{ route('Gaza.damage-map') }}" data-discover="true"><button data-slot="button"
