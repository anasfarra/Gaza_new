                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="mb-8">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <span
                                class="bg-slate-100 text-slate-600 text-xs px-2 py-1 rounded-md font-mono">PRJ-2026-001</span>
                        </div>
                        <p class="text-neutral-600 flex items-center gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="text-neutral-400">
                        ...
                        <div class="bg-white border rounded-xl p-6 shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12">
                                <div class="flex items-center justify-between py-3 border-b border-neutral-50">
                                    ...
                                    <div class="text-left font-bold">$35,000 <span
                                            class="text-xs text-neutral-400 ml-1">51%</span></div>
                                </div>
                                <div class="flex items-center justify-between py-3 border-b border-neutral-50">
                                    <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left font-bold">$22,000 <span
                                            class="text-xs text-neutral-400 ml-1">32%</span></div>
                                </div>
                                <div class="flex items-center justify-between py-3 border-b border-neutral-50">
                                    <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left font-bold">$9,500 <span
                                            class="text-xs text-neutral-400 ml-1">14%</span></div>
                                </div>
                                <div class="flex items-center justify-between py-3 border-b border-neutral-50">
                                    <div class="flex items-center gap-3">
                                    ...
                                    <div class="text-left font-bold">$2,000 <span
                                            class="text-xs text-neutral-400 ml-1">3%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
