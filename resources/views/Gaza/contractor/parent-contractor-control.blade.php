...
<head>
    ...
    <title>@yield('title', 'لوحة تحكم المقاول - منصة إعمار غزة')</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/Contractor.css') }}">
@yield('css')
</head>
    ...
    <div id="root">
        <div class="min-h-screen bg-slate-50">
            ...
            <header
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-20">
                        <a class="flex items-center gap-3 group" href="{{ route('Gaza.contractor-index') }}">
            ...
            <nav class="hidden lg:flex items-center gap-8">
                ...
                @endphp
                            <a class="{{ request()->routeIs('Gaza.contractor-index') ? $activeClass : $inactiveClass }}"
                                href="{{ route('Gaza.contractor-index') }}">الرئيسية</a>
                            <a class="{{ request()->routeIs('Gaza.contractor-damage-map') ? $activeClass : $inactiveClass }}"
                                href="{{ route('Gaza.contractor-damage-map') }}">خريطة الأضرار</a>
                            <a class="{{ request()->routeIs('Gaza.contractor-projects') ? $activeClass : $inactiveClass }}"
                                href="{{ route('Gaza.contractor-projects') }}">المشاريع</a>
                            <a class="{{ request()->routeIs('Gaza.Contractor') ? $activeClass : $inactiveClass }}"
                                href="{{ route('Gaza.Contractor') }}">لوحة المقاول</a>
                            <a class="{{ request()->routeIs('Gaza.contractor-marketplace') ? $activeClass : $inactiveClass }}"
                                href="{{ route('Gaza.contractor-marketplace') }}">السوق</a>
                            <a class="{{ request()->routeIs('Gaza.contractor-content') ? $activeClass : $inactiveClass }}"
                                href="{{ route('Gaza.contractor-content') }}">اتصل بنا</a>
                        </nav>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-right">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col gap-2 text-sm text-neutral-400">
                                <a href="{{ route('Gaza.contractor-damage-map') }}"
                                    class="hover:text-white transition-colors">خريطة الأضرار</a>
                                <a href="{{ route('Gaza.contractor-marketplace') }}" class="hover:text-white transition-colors">السوق</a>
