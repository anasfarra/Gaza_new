  ...
  <main>
    <section class="relative py-20 bg-slate-900 overflow-hidden">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6 fade-in-up" style="animation-delay: 0.1s;">
          نحن هنا <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">لمساعدتك</span>
        </h1>
